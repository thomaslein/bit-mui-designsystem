import {
  ...
  type SwipeableDrawerProps as BaseSwipeableDrawerProps,
} from '@mui/material';
import classNames from 'classnames';
import styles from './drawer.module.scss';

export interface SwipeableDrawerProps extends BaseSwipeableDrawerProps {
  /**
...
export function SwipeableDrawer({
  ...
  return (
    <BaseSwipeableDrawer
      className={classNames(styles.swipeableDrawer, className)}
      {...rest}
    >
      {children}
    </BaseSwipeableDrawer>
